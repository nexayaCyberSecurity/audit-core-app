#!/usr/bin/env python3
"""
Convert the official CCM Excel file to a Auditcore Excel workbook that follows
...
def main():
    parser = argparse.ArgumentParser(
        prog="convert_ccm_v2",
        description="Convert CCM official Excel file to a Auditcore v2 Excel file.",
    )
