...
class Command(BaseCommand):
    help = """Clone a Auditcore instance by copying the database and evidence attachments.

    This command creates a complete copy of a Auditcore instance, including:
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("\n" + "=" * 70)
        self.stdout.write(self.style.SUCCESS("Auditcore Instance Cloning"))
        ...
        try:
            ...
            self.stdout.write(
                ...
                + " To use the cloned instance, update your Auditcore"
            )
            self.stdout.write(
