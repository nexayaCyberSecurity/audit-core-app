"""
This module defines metrics for the Auditcore backend using the Prometheus client library.
...
nb_users_gauge = get_or_create_gauge(
    ...
    "Number of users in the Auditcore instance",
)
...
build_info = get_or_create_info(
    ...
    "Build information for the Auditcore instance",
)
