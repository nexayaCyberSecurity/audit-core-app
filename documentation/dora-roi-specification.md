...
> **Source of truth** for the mapping between the EBA XLS Master Template columns and Auditcore data model fields.
...
- the Auditcore model field that supplies the value;
...
- Required: Mandatory
- CSV header: `c0010`
- Auditcore field: Entity (main) > Legal Identifiers > LEI
...
- Required: Mandatory
- CSV header: `c0020`
- Auditcore field: Entity (main) > Name
...
- Required: Mandatory
- CSV header: `c0030`
- Auditcore field: Entity (main) > Country
...
- Required: Mandatory
- CSV header: `c0040`
- Auditcore field: Entity (main) > Entity Type (DORA section)
...
- CSV header: `c0050`
- Auditcore field: Entity (main) > Competent Authority (DORA section)
...
- Required: Mandatory in case of reporting
- CSV header: `c0060`
- Auditcore field: — (Auto: current date at export time)
...
- Required: Mandatory
- CSV header: `c0010`
- Auditcore field: Entity > Legal Identifiers > LEI
...
- Required: Mandatory
- CSV header: `c0030`
- Auditcore field: Entity > Country
...
- Required: Mandatory
- CSV header: `c0040`
- Auditcore field: Entity > Entity Type (DORA section)
...
- Required: Mandatory
- CSV header: `c0050`
- Auditcore field: Entity > Entity Hierarchy (DORA section)
...
- CSV header: `c0060`
- Auditcore field: Entity > Parent entity > Legal Identifiers > LEI
...
- Required: Mandatory
- CSV header: `c0070`
- Auditcore field: — (Auto: entity `updated_at` timestamp; `9999-12-31` if missing)
...
- Required: Mandatory
- CSV header: `c0080`
- Auditcore field: — (Auto: entity `created_at` timestamp; `9999-12-31` if missing)
...
- Required: Mandatory
- CSV header: `c0090`
- Auditcore field: — (Auto: `9999-12-31` for active entities)
...
- CSV header: `c0100`
- Auditcore field: Entity > Currency
...
- CSV header: `c0110`
- Auditcore field: Entity > Value of total assets (DORA section)
...
- Required: Mandatory
- CSV header: `c0010`
- Auditcore field: Entity (branch) > Legal Identifiers
...
- Required: Mandatory
- CSV header: `c0020`
- Auditcore field: Entity (branch) > Parent entity > Legal Identifiers > LEI
...
- Required: Mandatory
- CSV header: `c0030`
- Auditcore field: Entity (branch) > Name
...
- Required: Mandatory
- CSV header: `c0040`
- Auditcore field: Entity (branch) > Country
- Export: prefixed with `eba_GA:`
...
- Required: Mandatory
- CSV header: `c0010`
- Auditcore field: Contract > Reference ID
...
- Required: Mandatory
- CSV header: `c0020`
- Auditcore field: Contract > Contract type
...
- CSV header: `c0030`
- Auditcore field: Contract > Overarching Contract > Reference ID
...
- Required: Mandatory
- CSV header: `c0040`
- Auditcore field: Contract > Currency
...
- Required: Mandatory
- CSV header: `c0050`
- Auditcore field: Contract > Annual expense
...
- Required: Mandatory
- CSV header: `c0020`
- Auditcore field: Contract > Beneficiary Entity > Legal Identifiers > LEI
...
- Required: Mandatory
- CSV header: `c0030`
- Auditcore field: Contract > Provider Entity > Legal Identifiers
- Note: first available identifier (LEI > EUID > VAT > DUNS)
...
- Required: Mandatory
- CSV header: `c0040`
- Auditcore field: — (automatically determined based on identifier type used: LEI, EUID, VAT, DUNS)
...
- Required: Mandatory
- CSV header: `c0050`
- Auditcore field: Asset (business function) > Reference ID
...
- Required: Mandatory
- CSV header: `c0060`
- Auditcore field: Solution > ICT Service Type (DORA Assessment section)
...
- Required: Mandatory
- CSV header: `c0070`
- Auditcore field: Contract > Start date
...
- Required: Mandatory
- CSV header: `c0080`
- Auditcore field: Contract > End date
...
- CSV header: `c0090`
- Auditcore field: Contract > Termination reason
...
- CSV header: `c0100`
- Auditcore field: Contract > Notice period for entity (days)
...
- Required: Mandatory if the ICT service is supporting a critical or important function
- CSV header: `c0110`
- Auditcore field: Contract > Notice period for provider (days)
...
- Required: Mandatory if the ICT service is supporting a critical or important function
- CSV header: `c0120`
- Auditcore field: Contract > Governing law country
- Export: prefixed with `eba_GA:`
...
- Required: Mandatory if the ICT service is supporting a critical or important function
- CSV header: `c0130`
- Auditcore field: Contract > Provider Entity > Country
- Export: prefixed with `eba_GA:`
...
- Required: Mandatory if the ICT service is supporting a critical or important function
- CSV header: `c0140`
- Auditcore field: Solution > Storage of data (DORA Assessment section)
...
- CSV header: `c0150`
- Auditcore field: Solution > Location of data at rest
- Export: prefixed with `eba_GA:`
...
- CSV header: `c0160`
- Auditcore field: Solution > Location of data processing
- Export: prefixed with `eba_GA:`
...
- CSV header: `c0170`
- Auditcore field: Solution > Data Sensitiveness (DORA Assessment section)
...
- CSV header: `c0180`
- Auditcore field: Solution > Level of Reliance (DORA Assessment section)
...
- Required: Mandatory
- CSV header: `c0010`
- Auditcore field: Contract (subordinate) > Reference ID
...
- Required: Mandatory
- CSV header: `c0020`
- Auditcore field: Contract > Linked third-party contract reference
...
- CSV header: `c0030`
- Auditcore field: — (Auto: always `true`)
...
- Required: Mandatory
- CSV header: `c0020`
- Auditcore field: — (Auto: main entity identifier for all contracts)
...
- Required: Mandatory
- CSV header: `c0030`
- Auditcore field: — (automatically determined based on identifier type used)
...
- Required: Mandatory
- CSV header: `c0020`
- Auditcore field: — (Auto: provider entity LEI for intra-group contracts)
...
- Required: Mandatory
- CSV header: `c0030`
- Auditcore field: — (Auto: computed based on whether the entity is a branch)
...
- Required: Mandatory
- CSV header: `c0010`
- Auditcore field: Entity (provider) > Legal Identifiers
- Note: first available identifier (LEI > EUID > VAT > DUNS)
...
- Required: Nullable
- CSV header: `c0030`
- Auditcore field: Entity (provider) > Additional identifier (e.g. EUID)
...
- CSV header: `c0040`
- Auditcore field: — (automatically determined based on additional identifier type)
...
- Required: Mandatory
- CSV header: `c0050`
- Auditcore field: Entity (provider) > Name
...
- CSV header: `c0060`
- Auditcore field: Entity (provider) > Name (Latin alphabet transliteration)
...
- Required: Mandatory
- CSV header: `c0070`
- Auditcore field: Entity (provider) > Person Type (DORA section)
...
- Required: Mandatory
- CSV header: `c0080`
- Auditcore field: Entity (provider) > Country
- Export: prefixed with `eba_GA:`
...
- CSV header: `c0090`
- Auditcore field: Contract / Entity (main) > Currency
...
- CSV header: `c0100`
- Auditcore field: — (Auto: sum of `Annual expense` across all contracts with this provider)
...
- Required: Mandatory
- CSV header: `c0110`
- Auditcore field: Entity (provider) > Parent entity > Legal Identifiers
...
- Required: Nullable
- CSV header: `c0120`
- Auditcore field: — (automatically determined based on identifier type used for parent)
...
- Required: Mandatory
- CSV header: `c0020`
- Auditcore field: Solution > ICT Service Type
...
- Required: Mandatory
- CSV header: `c0040`
- Auditcore field: — (automatically determined)
...
- Required: Mandatory
- CSV header: `c0050`
- Auditcore field: — (Auto: always `1` — sub-contracting chains not modelled)
...
- CSV header: `c0060`
- Auditcore field: — (Auto: empty for rank 1)
...
- Required: Mandatory
- CSV header: `c0020`
- Auditcore field: Asset (business function) > Licensed activity (DORA section)
...
- Required: Mandatory
- CSV header: `c0030`
- Auditcore field: Asset (business function) > Name
...
- Required: Mandatory
- CSV header: `c0040`
- Auditcore field: — (Auto: main entity LEI)
...
- Required: Mandatory
- CSV header: `c0050`
- Auditcore field: Asset (business function) > Criticality assessment (DORA section)
...
- Required: Optional
- CSV header: `c0060`
- Auditcore field: Asset (business function) > Criticality justification (DORA section)
...
- Required: Mandatory
- CSV header: `c0070`
- Auditcore field: — (Auto: asset `updated_at` timestamp; `9999-12-31` if missing)
...
- Required: Mandatory
- CSV header: `c0080`
- Auditcore field: Asset (business function) > disaster_recovery_objectives > objectives > rto > value
...
- Required: Mandatory
- CSV header: `c0090`
- Auditcore field: Asset (business function) > disaster_recovery_objectives > objectives > rpo > value
...
- Required: Mandatory
- CSV header: `c0100`
- Auditcore field: Asset (business function) > Discontinuing Impact (DORA section)
...
- Required: Mandatory
- CSV header: `c0050`
- Auditcore field: Solution > Substitutability (DORA Assessment section)
...
- CSV header: `c0060`
- Auditcore field: Solution > Non-Substitutability Reason (DORA Assessment section)
...
- Required: Mandatory
- CSV header: `c0070`
- Auditcore field: — (Auto: solution `updated_at` timestamp)
...
- Required: Mandatory
- CSV header: `c0080`
- Auditcore field: Solution > Exit Plan (DORA Assessment section)
...
- Required: Mandatory
- CSV header: `c0090`
- Auditcore field: Solution > Reintegration Possibility (DORA Assessment section)
...
- Required: Mandatory
- CSV header: `c0100`
- Auditcore field: Solution > Discontinuing Impact (DORA Assessment section)
...
- Required: Mandatory
- CSV header: `c0110`
- Auditcore field: Solution > Alternative Providers Identified (DORA Assessment section)
...
- Required: Optional
- CSV header: `c0120`
- Auditcore field: Solution > Alternative Providers (DORA Assessment section)
