...
This document describes the email notification system in Auditcore, powered by **Huey** (async task queue) and **Django's email backend**.
...
```yaml
subject: "Auditcore: You have been assigned to '${control_name}'"
body: |
  Hello,
  ...
  Log in to your Auditcore portal:
  ${ciso_assistant_url}
