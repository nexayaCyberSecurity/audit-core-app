...
1. Login to Auditcore and generate a PAT: click on the three dots next to the email -> my profile -> settings
...
6. You can now chat with your data, either by mentioning some keywords like applied controls or risks, or explicitly asking about Auditcore.
