"""
Simple script to convert NIST SP-800-66 excel in a Auditcore Excel file
...
parser = argparse.ArgumentParser(
    ...
    description="convert NIST SP-800-66 controls official Excel file to Auditcore Excel file",
)
