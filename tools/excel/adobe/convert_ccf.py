"""
Simple script to convert Adobe CCF Security Controls v5 Excel in a Auditcore Excel file
...
parser = argparse.ArgumentParser(
    prog="convert_ccf",
    description="convert Adobe CCF Security Controls v5 Excel file to Auditcore Excel file",
)
