"""
simple script to transform the official NZISM XML file to an Excel file for Auditcore framework conversion tool
"""
...
parser = argparse.ArgumentParser(
    prog="convert_nzism",
    description="convert NZISM's XML file to Auditcore Excel file",
)
