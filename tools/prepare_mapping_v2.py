...
used in Auditcore. It extracts relevant metadata from the source and target
...
def main():
    ...
    parser = argparse.ArgumentParser(prog="prepare_mapping_v2.py", description="Prepare a mapping Excel file for Auditcore")
