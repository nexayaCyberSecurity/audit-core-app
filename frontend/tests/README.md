...
This project uses **Playwright** for end-to-end (E2E) tests that allow comprehensive testing of the Auditcore application by simulating real user interactions.
